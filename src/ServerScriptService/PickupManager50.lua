...
local HEALTH_RESTORED = 50

local healthPickupsFolder = workspace:WaitForChild("HealthPickups")
local healthPickupsFolder50 = healthPickupsFolder:WaitForChild("HealthPickups50")
local healthPickups = healthPickupsFolder50:GetChildren()
