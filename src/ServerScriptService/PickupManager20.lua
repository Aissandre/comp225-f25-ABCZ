...
local HEALTH_RESTORED = 20

local healthPickupsFolder = workspace:WaitForChild("HealthPickups")
local healthPickupsFolder20 = healthPickupsFolder:WaitForChild("HealthPickups20")
local healthPickups = healthPickupsFolder20:GetChildren()
